			...
			<form method="POST" onSubmit={this.updateProfile.bind(this)}>
				<div className="flex p-4">
					<div className="w-full">
						<h4 className="text-grey-dark font-normal mb-4 text-lg">Personal Information</h4>
						<div className="flex mb-6">
							<div className="w-1/2 mr-2">
								<label className="text-grey-darker text-xs uppercase tracking-wide block mb-2">Contact Category/Type</label>
							...
							<div className="w-1/2 ml-2">
								<label className="text-grey-darker text-xs uppercase tracking-wide block mb-2">Contact Source</label>
								<div className="inline-block relative w-full">
						...
						<div className="mb-2">
							<label className="text-grey-darker text-xs uppercase tracking-wide block mb-2">Full Name</label>
						</div>
						<div className="flex mb-6">
						...
						<div className="flex mb-6">			
							<div className="w-1/2 mr-2">
								<label className="text-grey-darker text-xs uppercase tracking-wide block mb-2">Email</label>
							...
							<div className="w-1/2 ml-2">
								<label className="text-grey-darker text-xs uppercase tracking-wide block mb-2">Mobile</label>
								<div className="relative">
						...
						<div className="flex mb-6">			
							<div className="w-1/2 mr-2">
								<label className="text-grey-darker text-xs uppercase tracking-wide block mb-2">Phone</label>
								<input value={state.phone} onChange={(e) => this.setState({ phone: e.target.value })} className="shadow border rounded w-full px-3 py-2" />
							</div>
							<div className="w-1/2 ml-2">
								<label className="text-grey-darker text-xs uppercase tracking-wide block mb-2">Fax</label>
								<input value={state.fax} onChange={(e) => this.setState({ fax: e.target.value })} className="shadow border rounded w-full px-3 py-2" />
							</div>						
						</div>
						<div className="flex mb-6">			
							<div className="w-full">
								<label className="text-grey-darker text-xs uppercase tracking-wide block mb-2">Nationality</label>
				...
				<div className="flex p-4">
					<div className="w-full">
						<h4 className="text-grey-dark font-normal mb-4 text-lg">Additional Information</h4>
						<div className="flex mb-6">
							<div className="w-1/2 mr-2">
								<label className="text-grey-darker text-xs uppercase tracking-wide block mb-2">Company Name</label>
							...
							<div className="w-1/2 ml-2">
								<label className="text-grey-darker text-xs uppercase tracking-wide block mb-2">Position</label>
				...
				<div className="flex px-4 pt-4 pb-8">
					<div className="w-full flex justify-end">
						<button type="reset" className="text-grey-darker btn-link px-4 py-2 mr-2">Cancel</button>
						<button 
