	...
	<div class="w-full bg-white rounded shadow">
		<div class="px-6 pt-6">
			<div class="flex items-center justify-between">
				<h1 class="text-grey-darker text-2xl font-semibold pb-4">
					Contacts <small>({{ $total_contacts }})</small>
				</h1>
				<div class="flex">
					<a href="/admin/contacts/create" class="bg-white border border-solid border-grey-light shadow py-2 px-4 rounded text-grey-dark hover:text-black no-underline">
						<i class="fa fa-plus mr-1"></i> New
					</a>
					<a href="/admin/contacts/import" class="bg-white border border-solid border-grey-light shadow py-2 px-4 rounded text-grey-dark hover:text-black no-underline ml-1">
