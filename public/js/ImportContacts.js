...
/***/ "./resources/assets/js/ImportContacts.js":
...
var ImportContacts = function (_React$Component) {
	_inherits(ImportContacts, _React$Component);

	function ImportContacts(props) {
		_classCallCheck(this, ImportContacts);

		var _this = _possibleConstructorReturn(this, (ImportContacts.__proto__ || Object.getPrototypeOf(ImportContacts)).call(this, props));
	...
	_createClass(ImportContacts, [{
		...
		value: function render() {
			...
			var submitButtonClasses = __WEBPACK_IMPORTED_MODULE_2_classnames___default()('bg-blue', 'hover:bg-blue-dark', 'text-white', 'px-4', 'py-2', 'rounded', { 'opacity-50': this.state.formWasSubmitted });
			...
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'h1',
						{ className: 'text-grey-darker text-2xl font-semibold pb-4' },
						'Import contacts'
					),
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'p',
						{ className: 'text-grey-dark leading-normal' },
						'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.'
					),
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'flex py-4 mt-4' },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							{ className: 'w-1/2 mr-8' },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'h4',
								{ className: 'text-grey-dark mb-2' },
								'Export sample format'
							),
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'p',
								{ className: 'text-grey text-xs font-normal leading-normal mb-2' },
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'a',
									{ href: '#', className: 'no-underline text-blue-dark' },
									'Download'
								),
								' sample CSV format and be sure to follow the format properly.'
							),
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'p',
								{ className: 'text-grey text-xs font-normal leading-normal mb-2' },
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									...
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
										'label',
										{ className: 'text-grey text-xs font-semibold uppercase tracking-wide block mb-4' },
										'Browse CSV'
									),
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'file', name: 'csv', id: 'csv', className: 'shadow border rounded w-full px-3 py-2', onChange: function onChange(e) {
											return _this3.setState({ csv: e.target.value });
										} })
								)
							)
						)
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'flex bg-grey-lighter border-t px-6 py-3' },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'button',
							{ className: submitButtonClasses, disabled: this.state.formWasSubmitted ? 'disabled' : '' },
							this.state.formWasSubmitted ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: 'fa fa-spinner fa-spin mr-2' }) : '',
...
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(ImportContacts, null), document.getElementById('ImportContacts'));
...
module.exports = __webpack_require__("./resources/assets/js/ImportContacts.js");
